...
DEVICE_BATCH_SIZE = 64  # per-device batch size (A6000 48GB)
...
qkv_tracker = qkv_logger.init(model, log_dir="./qkv_logs", detail_every=50, hook_filter="linear", hook_every=2)
